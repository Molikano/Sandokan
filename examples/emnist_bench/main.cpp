...
// (copied verbatim from examples/benchmark/main.cpp)
// ============================================================
struct LayerEigen {
    Eigen::MatrixXf W, dW;
...
// ============================================================
// Harnesses — return one ms value per timed epoch
// (1 warmup epoch excluded from timing, identical to benchmark)
// ============================================================
...
int main() {
    ...
    const std::string        out_csv    = "emnist_bench.csv";

    std::printf("Loading EMNIST Letters...\n");
    ...
    std::printf("Run  python3 scripts/plot_emnist_bench.py  to generate figures.\n");
    return 0;
}
